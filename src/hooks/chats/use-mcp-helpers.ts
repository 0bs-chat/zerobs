...
export function getMcpLogoUrl(templateKey?: string): string {
  ...
  return template?.image ?? "https://avatars.githubusercontent.com/u/182288589?s=200&v=4";
}
...
export function getMcpDisplayInfo(templateKey: string): McpDisplayInfo {
  ...
  return {
    ...
    icon: template?.image || "https://avatars.githubusercontent.com/u/182288589?s=200&v=4",

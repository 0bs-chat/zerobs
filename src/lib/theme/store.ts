...
const DEFAULT_THEME: ThemeState = {
  ...
  cssVars: {
    ...
    light: {
      ...
      "shadow-sm":
        "0px 2px 3px 0px hsl(28 18% 25% / 0.18), 0px 1px 2px -1px hsl(28 18% 25% / 0.18)",
      shadow:
        "0px 2px 3px 0px hsl(28 18% 25% / 0.18), 0px 1px 2px -1px hsl(28 18% 25% / 0.18)",
      "shadow-md":
        "0px 2px 3px 0px hsl(28 18% 25% / 0.18), 0px 2px 4px -1px hsl(28 18% 25% / 0.18)",
      "shadow-lg":
        "0px 2px 3px 0px hsl(28 18% 25% / 0.18), 0px 4px 6px -1px hsl(28 18% 25% / 0.18)",
      "shadow-xl":
        "0px 2px 3px 0px hsl(28 18% 25% / 0.18), 0px 8px 10px -1px hsl(28 18% 25% / 0.18)",
  ...
  DEFAULT_THEME,
  {
    getItem: (key) => {
      try {
        ...
        console.warn(
          "Error reading theme from localStorage, using default:",
          error,
        );
        return DEFAULT_THEME;
      }

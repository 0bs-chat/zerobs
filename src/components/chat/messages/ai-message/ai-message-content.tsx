...
export const AiMessageContent = memo(({ message, messageId, showReasoning = true }: AiMessageContentProps) => {
  ...
  const messageContent = useMemo(() => {
    if (type === "ai") {
      return (
        <>
          {showReasoning && <Reasoning reasoning={reasoning} messageId={messageId} />}
          <div className="">
            {renderedContent}
          </div>
        </>
  ...
  }, [type, showReasoning, reasoning, messageId, renderedContent, message]);

...
export function ThemeSwitcher() {
    const [isImportDialogOpen, setIsImportDialogOpen] = useAtom(importDialogOpenAtom)
        ...
        <>
            ...
            <div className="flex items-center gap-2">
                <Button
                    ...
                    onClick={toggleMode}
                >
                    <SunIcon className="dark:-rotate-90 h-3.5 w-3.5 rotate-0 scale-100 transition-all dark:scale-0 dark:-rotate-90" />
